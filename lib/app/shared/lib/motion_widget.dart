...
class Motion<T extends Flex> extends StatefulWidget {
  ...
  Motion(
      ...
      required this.exitConfigurations,
  ...
  void processChildren() {
    widget.children.forEach((child) {
      if (child is MotionElement)
        processedChildren
            .add(getMotionBuilder(child, widget.motionController!));
      else
  ...
  Widget getMotionBuilder(MotionElement child, AnimationController animCont,
    ...
    switch (child.mode) {
      case MotionMode.TRANSLATE_FADE:
        ...
        //     getOpacAnim(child, animCont, isExit) as Animation<double>;

        builder = FadeTransition(
          opacity: getOpacAnim(child, animCont, isExit) as Animation<double>,
